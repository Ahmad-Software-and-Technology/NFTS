                    ...
                    <div className="slider-inner flex home-1 style-2">
                        ...
                        <div className="slider-img flex">
                            ...
                            <div className="img-right">
                                <img src={props.item.img3} alt="NFTYART" />
                                <div className="box-avatar flex">
                                    <div className="list-avatar flex">
                                        <img src={props.item.avt1} alt="NFTYART" />
                                        <img src={props.item.avt2} alt="NFTYART" />
                                        <img src={props.item.avt3} alt="NFTYART" />
                                        <img src={props.item.avt4} alt="NFTYART" />
                                    </div>
