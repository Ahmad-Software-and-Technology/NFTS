          ...
          <div className="slider-inner  home-1">
            <div className="slider-content">
              <h1 className="heading">
                Welcome To NFTyART Welcome  to the future of ART
              </h1>
              <p className="sub-heading">{props.item.description}</p>
              <div className="button-slider">
                <Link
                  to="/explore-01"
                  className="sc-button btn-bordered-white style letter my-2"
                >
                  <span>Explore More</span>
                </Link>
                <Link
                  to="/create-item"
                  className="sc-button btn-bordered-white style file my-2"
                >
