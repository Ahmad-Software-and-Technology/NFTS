                        ...
                        <div key={index} className="col-lg-4 col-md-6">
                            <article className="sc-card-article">
                                <div className="card-media">
                                    <Link to="/blog-details"><img src={item.img} alt="NFTYART" /></Link>
                                </div>
                                <div className="content">
                                    ...
                                    <div className="text-article">
                                        ...
                                        <div className="item date">{item.description}</div>
                                        <p>{item.royality}</p>
                                    </div>
                                    <btn 
                                        className="sc-button  style-2 mr-4 "><span>Buy</span></btn>
                                    <btn 
                                        className="sc-button  style-2 "><span>Sell</span></btn>
                                </div>
                            </article>
                        </div>
                    ))
